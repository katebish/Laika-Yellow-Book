...
public class NewEntryActivity extends AppCompatActivity implements AsyncResponse,TwinCalfDialogListener {
    ...
    List<Integer> twinIDs = new ArrayList<Integer>();
    List<String> twinSex = new ArrayList<String>();
    List<Double> twinBWs = new ArrayList<Double>();
    List<String> twinConditions = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twin1chip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tag = "reopen";
                reopenTwinCalfDialog(1);
            }
        });
        ...
        twin1chip.setOnCloseIconClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                twinBWs.remove(0);
                twinSex.remove(0);
                twinConditions.remove(0);

                if (twinCount == 1) {
                    twin2chip.setVisibility(View.INVISIBLE);
                    twin1chip.setVisibility(View.VISIBLE);
                    twin1chip.setText("Twin: " + twinIDs.get(0).toString());
                }
                ...
                if (twinCount == 2) {
                    ...
                    twin3chip.setVisibility(View.INVISIBLE);
                    twin2chip.setVisibility(View.VISIBLE);
                    twin2chip.setText("Twin: " + twinIDs.get(1).toString());
                }
            }
        });

        twin2chip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tag = "reopen";
                reopenTwinCalfDialog(2);
            }
        });
        ...
        twin2chip.setOnCloseIconClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                twinBWs.remove(1);
                twinSex.remove(1);
                twinConditions.remove(1);

                if(twinIDs.get(1) != null) {
                    twin3chip.setVisibility(View.INVISIBLE);
                    twin2chip.setVisibility(View.VISIBLE);
                    twin2chip.setText("Twin: " + twinIDs.get(1));
                }

            }
        });

        twin3chip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tag = "reopen";
                reopenTwinCalfDialog(3);
            }
        });
    ...
    private void reopenTwinCalfDialog(Integer twin){
        tag = "reopen";
        TwinCalfDialog twinCalfDialog = new TwinCalfDialog();
        if(twin == 1) twinCalfDialog.show(getSupportFragmentManager(), "reopen twin 1");
        else if (twin == 2) twinCalfDialog.show(getSupportFragmentManager(), "reopen twin 2");
        else twinCalfDialog.show(getSupportFragmentManager(), "reopen twin 3");
    }
    ...
    public void passData(int calfID, String calfSex, Double calfBW, String calfCondition) {
        ...
        switch (twinCount) {
            case 0:
                //Chip twin1chip = findViewById(R.id.twin1chip);
                twin1chip.setVisibility(View.VISIBLE);
                twin1chip.setText("Twin: " + id.toString());
                twinCount++;
                break;

            case 1:
                twin2chip.setVisibility(View.VISIBLE);
                        twin2chip.setText("Twin: " + id.toString());
                        twinCount++;
               break;
            ...
            case 2:
                if(tag == "open"){
                    twin3chip.setVisibility(View.VISIBLE);
                    twin3chip.setText("Twin: " + id.toString());
                    twinCount++;
                }
               break;
        }
        ...
        if(tag == "open") {
            twinIDs.add(calfID);
            if(calfSex == null) twinSex.add("");
            else twinSex.add(calfSex);
            twinBWs.add(calfBW);
            if (calfCondition == null) twinConditions.add("");
            else twinConditions.add(calfCondition);
        }

        for(int i = 0; i < twinCount; i++) {
            if (!(id.equals(twinIDs.get(i)))) twins.add(twin);
        }

    }

    @Override
    public List<String> getTwinData(Integer twin){
        List<String> twinsData = new ArrayList<String>();
        if(twin == 1) {
            twinsData.add(twinIDs.get(0).toString());
            twinsData.add(twinSex.get(0));
            twinsData.add(twinBWs.get(0).toString());
            twinsData.add(twinConditions.get(0));
        }
        else if (twin == 2) {
            twinsData.add(twinIDs.get(1).toString());
            twinsData.add(twinSex.get(1));
            twinsData.add(twinBWs.get(1).toString());
            twinsData.add(twinConditions.get(1));
        }
        else {
            twinsData.add(twinIDs.get(2).toString());
            twinsData.add(twinSex.get(2));
            twinsData.add(twinBWs.get(2).toString());
            twinsData.add(twinConditions.get(2));
        }
